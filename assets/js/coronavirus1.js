function CoronavirusWarning(language) {
    ...
    this.langs = {
        ...
        'RU': {
            desk: '<div><p>No se preocupe, ¡nos tomamos muy en serio la seguridad de nuestros clientes!</p><p>Nuestros mensajeros cambian máscaras y guantes cada 2 horas. Proceso de entrega y pago: sin contacto</p></div>',
            mob: '<div><p>No se preocupe, ¡nos tomamos muy en serio la seguridad de nuestros clientes!</p><p>Nuestros mensajeros cambian máscaras y guantes cada 2 horas. Proceso de entrega y pago: sin contacto</p></div>'
        }
    };
