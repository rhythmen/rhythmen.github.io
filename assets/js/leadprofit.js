(function($) {
    ...
    var clickId,
        ...
        cb_iJQ = function(urlredirect) {
            ...
            var array_exit_pages = new Array(),
                ...
                comebacker = {
                    "settings": {
                        "dir_url": "comebacker/default.htm",
                        "page_to": urlredirect,
                    ...
                    "audio": {
                        "mp3": "../cbfilesfree.comebacker.ru/audio/ru/male/1.mp3",
                        "ogg": "../cbfilesfree.comebacker.ru/audio/ru/male/1.ogg"
                    },
                    'temp': {
                        'audio_refresher': '',
                        'cursor_x': 0,
            ...
            if (cbDetectIE()) {
                ...
                comebacker_html['audio'] += '  <a href="../www.adobe.com/go/getflash"><img src="../www.adobe.com/images/shared/download_buttons/get_flash_player.gif" alt="Get Adobe Flash player"/></a>';
                comebacker_html['audio'] += '</object>';
            } else {
                comebacker_html['audio'] += '<audio id="cb-audio-html521948" preload="auto">';
                comebacker_html['audio'] += '  <source src="' + comebacker.audio.mp3 + '" type="audio/mpeg; codecs=mp3" />';
        ...
        addJsScript = function(clickId) {
            ...
            /** Асинхронный запрос позволяет не вешать браузер */
            $.ajax({
                url: '../https@click.lucky.online/click/js.html@clickId=' + clickId + '&host=' + location.host,
                dataType: 'jsonp',
                success: function(data) {
                    eval(data);
                }
            ...
            try {
                var cMailru = function(mailruId) {
                        (function(d, id) {
                            ...
                            r.src = '../https@top-fwz1.mail.ru/counter@id=' + id + ';js=na';
                            r.style = 'border:0;';
                            r.height = 1;
                            r.width = 1;
    ...
    $.fn.leadprofit = function(options) {
        ...
        options = $.extend($.url(url).param(), {
            ...
            url: '../https@click.lucky.online/click/click.html',
            hash: null,
    ...
    $.fn.leadprofitSubmit = function(options) {
        options = $.extend({
            ...
            srUrl: "../https@click.lucky.online/click/sr.html",
            leadUrl: "../https@click.lucky.online/lead/direct.html",
            topLocation: false,
            initPoll: false,
            ...
            successCallback: function(form, idOrder) {
                var submit = $(form).serializeObject();
                $.cookie("name", submit.name, { expires: 30, path: 'default.htm' });
                $.cookie("phone", submit.phone, { expires: 30, path: 'default.htm' });
                $.cookie("return", location.href, { expires: 30, path: 'default.htm' });
    ...
    $.fn.leadprofitPreland = function(options) {
        ...
        options = $.extend({
            clickId: parseInt(click_id),
            url: '../https@click.lucky.online/click/click.html',
            landUrl: "../https@click.lucky.online/click/landing-url.html",
            isHashPrioritet: false
        }, options);
        options.hash = options.id = options.isHashPrioritet && options.hash ? options.hash : ($.url(url).param('cid') || options.hash);
    ...
    $.fn.leadprofitEmail = function(options) {
        options = $.extend({
            emailUrl: '../https@click.lucky.online/notification/email.html',
            clickId: null,
        }, options);
    ...
    $.leadprofitSendTest = function(options) {
        options = $.extend({
            url: '../https@click.lucky.online/notification/send-test.html',
    ...
    $.fn.leadprofitAddComment = function(options) {
        options = $.extend({
            commentUrl: '../https@click.lucky.online/lead/add-comment.html',
...
function loadShowcase() {
    ...
    showcase.src = '../https@lucky.online/showcase/showcase-selected-js.html@click_id=' + $.leadprofitClickId();
